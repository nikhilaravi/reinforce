...
var helpers = {
  ...
  dictToArray: function dictToArray(dict) {
    ...
    var key = void 0;
    return Object.keys(dict).sort().reduce(function (arr, elem) {
      key = elem;
      if (num) {
...
var FollowerDegrees = function (_VisualizationBase) {
  ...
  createClass(FollowerDegrees, [{
    ...
    value: function update(Nodes) {
      var follower_counts_dict = dictToArray$2(create_count_dict(Nodes, 'followedBy'), true); // an array of arrays of the form [[num_followers, num_nodes], [num_followers, num_nodes]] etc
...
var FollowingDegrees = function (_VisualizationBase2) {
  inherits(FollowingDegrees, _VisualizationBase2);

  function FollowingDegrees(svg, width, height, testName) {
    classCallCheck(this, FollowingDegrees);

    var _this2 = possibleConstructorReturn(this, (FollowingDegrees.__proto__ || Object.getPrototypeOf(FollowingDegrees)).call(this, svg, width, height, testName));

    _this2.history = [];
    return _this2;
  }

  createClass(FollowingDegrees, [{
    key: 'update',
    value: function update(Nodes) {
      var following_counts_dict = dictToArray$2(create_count_dict(Nodes, 'following'), true); // an array of arrays of the form [[num_following, num_nodes], [num_following, num_nodes]] etc
      this.history.push(follower_counts_dict);
    }
  }, {
    key: 'clear',
...
var charts = { ConvergenceTimeseries: ConvergenceTimeseries, AssortativityChart: AssortativityChart, DiversityHistogram: DiversityHistogram };
...
var updateDiversity$1 = function updateDiversity$1(left) {
...
var loop = function loop() {
  ...
  for (var _i4 = 0; _i4 < Nodes.length; _i4++) {
    var _node = Nodes[_i4];
    var opacity = 254;
    if (activeNode && _node.id !== activeNode.id) {
      var mutualFollow = _node.following.map(function (f) {
        return f.id;
      }).indexOf(activeNode.id) > -1 && activeNode.following.map(function (f) {
        return f.id;
      }).indexOf(_node.id) > -1;
      if (!mutualFollow) {
        opacity = 100;
...
document.addEventListener("mousemove", function (e) {
  ...
  if (match) {
    var diversity = match[2].diversity;
    var jaccardValues = match[2].getSimilarityOfInitialAndCurrFollowingSets();
